...
def carregar_dados_pedidos():
    df_pedido = pd.read_csv('dados/pedidos.csv')
...
def carregar_dados_receitas():
    df_receitas_insumos = pd.read_csv('dados/receitas_insumos.csv')
    df_insumos = pd.read_csv('dados/insumos.csv')
...
def carregar_itens_pedido():
    df_itens_pedido = pd.read_csv('dados/itens_pedido.csv')
